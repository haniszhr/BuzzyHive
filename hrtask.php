...
-->   </li>
         ...
         <li class="dropdown " >
              ...
              <li class="nav-tabs">
                <a href="leavetry.php" >Leave Application</a>   </li>  </ul>  </div>
...
$sql="SELECT * FROM task WHERE namestaff='".$staff."'";
      ...
      <a href="hrtask2.php?id=<?php echo $row["Taskid"]; ?>" value="Complete" class="settings" title="Change Status to Complete" data-toggle="tooltip"><i class="material-icons">done</i></a> <?php } 
      else if(($status=='Reject')){ ?>
        <a href="hrtask2.php?id=<?php echo $row["Taskid"]; ?>" value="Complete" class="settings" title="Change Status to Complete" data-toggle="tooltip"><i class="material-icons">done</i></a> 
     <?php }
