...
<hr>
         ...
         <hr>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12"> <form action="taskstaff4.php" method="post">
...
<tr>                      <th>Request By</th>
 ...
 $detail=$row['Detail'];
  ...
  <td >
      ...
      <a href="taskstaff5.php?id=<?php echo $row["Taskid"]; ?>" value="Approve" class="settings" title="Click to approve" data-toggle="tooltip"><i class="material-icons">thumb_up</i></a> <?php } 
      else if(($status=='Approve')){ ?>
        <a href="taskstaff6.php?id=<?php echo $row["Taskid"]; ?>" value="Reject" class="settings" title="Click to reject" data-toggle="tooltip"><i class="material-icons">thumb_down</i></a> 

     <?php }
   
      ?>
       <a href="updatelinkstaff.php?id=<?php echo $row["Taskid"]; ?>" class="settings" title="Update Task" data-toggle="tooltip"><i class="material-icons">upgrade</i></a>
        </td>
   </tr>
