...
-->
         ...
         <li class="dropdown active" >
                ...
                <ul class="dropdown-menu"  >
                  <li class="active"> <a href="hrmenu.php" >Home</a></li>
                  <li>
      ...
      <div class="row">
        <div class="col-md-8  col-sm-8">
          <div class="slider-text wow fadeIn animated" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
            <h2 class="wow fadeInLeft animated" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInLeft;">Good Day <?php echo $_SESSION['name']?></h2>
            ...
            <h3 class="wow fadeIn animated" data-wow-delay="2s" style="visibility: visible; animation-delay: 2s; animation-name: fadeIn;">View Latest Announcement</h3>
            <a href="#display" class="button-normal yellow wow fadeIn animated" data-wow-delay="2.5s" style="visibility: visible; animation-delay: 2.5s; animation-name: fadeIn;">Let's check announcement board</a> </div>
        </div>
        <div class="slider-form col-md-4  col-sm-4 wow fadeIn text-center animated" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
          <div class="form-wrap">
            ...
            <form action="announce.php" method="post">
                ...
                <textarea name="description" cols="10" rows="8" placeholder="Description"></textarea>
                <input type="submit" class="btn_fill" value="Add New Announcement">
    ...
    <div class="row">
      <div class="history-section">
        <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <a class="link_arrow dark_border top40" href="https://www.hive-asia.com/" style=" background:rgb(248, 157, 10);border:0px">Read More</a>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-12">
