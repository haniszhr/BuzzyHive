...
<div class="col-xs-12">
       ...
       if($con->connect_error){
           ...
           if($res->num_rows > 0){
             ...
             if($db->connect_error){
              ...
              <?php }}}
               ?>
                   <form action="uploadhrimages.php"  id="imagesave" method="post" enctype="multipart/form-data"> 
                  <div class='file-input' style="margin-left:15px">
        <input type='file' name="fileToUpload" id="fileToUpload" >
        <span class='button'>Choose Image</span>
        <span class='label' data-js-label> Min 215px x 215px</label> 
      ...
      <button type="submit" name="submit" class="btn_fill" style="padding:7px;margin-bottom:15px;margin-left:0px">  <i class="fa fa-arrow-up"></i>

               </form>
                </div>
                             
          <form action="hrprofileupdate.php" method="post">                                      
...
<!-- <div class="row">
  <div class="col-md-9">
  <div class="single-query">
                  <input type="email" placeholder="Email Adress" name="Email"class="keyword-input">
  </div>  </div> </div>
-->
 ...
 <div class="row">
  ...
  <div class="row">
                 ...
                 <input type="submit"   class="btn_fill" name="submit" value="Update ">
                      ...
                      <div class="address_box">
                          ...
                          <div class="agent-p-contact p-t-30">
                            ...
                            <p><i class="icon-profile"></i>Name: <?php echo $name ?></p>
                              ...
                              <p><i class="icon-office"></i>Department: <?php echo $depart ?></p>
                            </div>
