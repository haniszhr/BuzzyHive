...
$detail=$row['Detail'];
 ...
 ?>
         ...
         <hr><p> Update the link for this task if necessary</p>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12"> <form action="stafftask5.php" method="post">
...
<tr>                      <th>Request By</th>
 ...
 $detail=$row['Detail'];
  ...
  <?php if(($status=="Not complete")){ ?>
      <a href="stafftask2.php?id=<?php echo $row["Taskid"]; ?>" value="Complete" class="settings" title="Change Status to Complete" data-toggle="tooltip"><i class="material-icons">done</i></a> <?php } 
      else if(($status=='Reject')){ ?>
        <a href="stafftask2.php?id=<?php echo $row["Taskid"]; ?>" value="Complete" class="settings" title="Change Status to Complete" data-toggle="tooltip"><i class="material-icons">done</i></a> 
     <?php }
      
   
      ?>
    <a href="stafftask4.php?id=<?php echo $row["Taskid"]; ?>" class="settings" title="See Detail" data-toggle="tooltip"><i class="material-icons">upgrade</i></a>
        </td>
   </tr>
