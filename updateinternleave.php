...
.btn_fill2{
    ...
    input[value="Approved"].btn_fill2:hover {
  border: none !important;
  background:rgb(25, 124, 84) !important;

} 
input[value="Pending"].btn_fill2:hover {
  border: none !important;
  background:#89949d!important;

} 
input[value="Rejected"].btn_fill2:hover {
  border: none !important;
...
<header id="main_header">
  ...
  <nav class="navbar navbar-default navbar-sticky bootsnav">
    <div class="container">
      ...
      <!--        <li class="dropdown" >
                <a href="staffprofile.php" class="dropdown-toggle header-login" >Profile</a>
               -->
            <!--  <ul class="dropdown-menu"  >
                  <li><a href="viewdesign.html">View Design</a></li>
                  <li><a href="adddesign.html">Add Design</a></li>
              ...
              <li class="dropdown" >
                <a href="#" class="dropdown-toggle header-login" >Leaves</a>
               
                <ul class="dropdown-menu"  >
                  <li><a href="internleave.php">Apply Leaves</a></li>
                  <li><a href="viewinternleaves.php">View Application Status</a></li>
          ...
          <div class="col-md-12">
            <div class="property-tab">
              ...
              <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active"><a href="#summary" aria-controls="summary" role="tab" data-toggle="tab">Leave Application</a></li>
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane " id="description">
                  ...
                  <p class="p-font-15">This section will display detail od leave application that you choose to update</p>
     ...
     ?>
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="property-query-area">
          ...
          <div class="row">
          <form action="updateinternleave2.php" method="post" enctype="multipart/form-data">
