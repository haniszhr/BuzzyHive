...
.file-input>.btn_fill{
  margin-bottom:20px !important;padding:3px !important;
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="images/logo-white.png" class="logo_eig" alt=""></a>
          </div> <!-- End Header Navigation --> 

          <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="nav navbar-nav navbar-right"data-in="fadeInDown" data-out="fadeOutUp">
             <!-- <li class="nav-tabs active" >
                <a href="hrmenu.php" >Home</a>  </li>--> 
...
<div class="col-xs-12">
       ...
       if($con->connect_error){
           ...
           if($res->num_rows > 0){
             ...
             if($db->connect_error){
              ...
              <?php }}}
               ?>
                   <form action="uploadstaffimage.php"  id="imagesave" method="post" enctype="multipart/form-data"> 
      ...
      <button type="submit" name="submit" class="btn_fill" style="padding:7px;margin-bottom:15px">
        <i class="fa fa-arrow-up"></i>
          ...
          <form action="staffprofile2.php" method="post">                                      
