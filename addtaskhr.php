...
-->
         ...
         <li class="dropdown" >
              ...
              <li class="dropdown active" >
                ...
                <ul class="dropdown-menu"  >
                  <li class="active"> <a href="viewstatusleaves.php" >Assign Task</a></li>
                  <li>
...
$id=$_REQUEST['id'];?>
    <?php     
        ...
        while($row=$res->fetch_assoc()){ 
          ...
          if(!empty($row['image'])){ ?><img src="./profile/<?php echo $row['image']; ?>"  class="img-responsive" alt="image"> <?php }
              else if (empty($row['image'])){
       ?><img src="images/profile.png" class="avatar" alt="image" class="img-responsive" alt="image">
     <?php  }  ?>
        ...
        <div class="agent-p-contact">
          <div class="our-agent-box padding-b-30">
            <h3><i class="icon-icons230"> </i><?php echo $name ?></h3>
...
<hr>
              <div class="our-agent-box padding-b-30">
              <h2 class="text-uppercase" style="margin-left:15px;margin-bottom:10px">Add a <span style="color:rgb(248, 157, 10)"> New Task</span></h2>
         <hr>
          </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12"> <form action="departliststaff.php" method="post">
                  <div class="single-query form-group" >
                <label>Title</label>
                    <input class="keyword-input" name="title" required="" type="text">
                  </div>
                </div>
      
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="single-query form-group" >     <label>Date Request</label>
                  <input required type="text" class="keyword-input" name="datereq" onfocus="(this.type='date')"/>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="single-query form-group" >
                  <label>Deadline</label>
                  <input required type="text" class="keyword-input" name="deadline"  onfocus="(this.type='date')"/>
                  </div>
                </div>
             <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="single-query form-group" >
                  <label>Link to submit</label>
                  <input type="url" class="keyword-input" name="link"/>
                  </div>
                </div>
                <div class="col-md-12 top20">     <label>Details of Task</label>
                  <textarea name="description" id="description" rows="7" class="form-control description">
             </textarea>
                </div>
                <div class="col-md-12 top20">
                    <button type="submit" class="btn_fill"name="submit" id="btn_submit">Add Task</button>
                  </div> </form>
            </div>
          </div>
...
<hr>
              <div class="our-agent-box padding-b-30">
              <h2 class="text-uppercase" style="margin-left:15px;margin-bottom:10px">List of <span style="color:rgb(248, 157, 10)">Task</span></h2>
         <hr>
          </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
...
<tr>                      <th>Request By</th>
      ...
      <?php
        ...
        $sql="SELECT * FROM `task` where namestaff='".$id."' ";
           $res=$con->query($sql);
 ...
 $detail=$row['Detail'];
  ...
  <td >
      ...
      <a href="addtaskhr2.php?id=<?php echo $row["Taskid"]; ?>" value="Approve" class="settings" title="Click to approve" data-toggle="tooltip"><i class="material-icons">thumb_up</i></a> <?php } 
      else if(($status=='Approve')){ ?>
        <a href="addtaskhr3.php?id=<?php echo $row["Taskid"]; ?>" value="Reject" class="settings" title="Click to reject" data-toggle="tooltip"><i class="material-icons">thumb_down</i></a> 

     <?php }
   
      ?>
       <a href="hrtaskupdate.php?id=<?php echo $row["Taskid"]; ?>" class="settings" title="Update Task" data-toggle="tooltip"><i class="material-icons">upgrade</i></a>
        </td>
   </tr>
