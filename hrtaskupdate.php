...
$sql="SELECT task.Taskid,task.Datereq,task.Status,task.Dateline,task.Title,task.Link,task.Detail,staff.Name from task join staff on staff.StaffId=task.namestaff where Taskid='".$id."'";
$res=$con->query($sql);
...
$sname=$row['Name'];
 ?>
           <div class="our-agent-box padding-b-30">
              <h2 class="text-uppercase" style="margin-left:15px;margin-bottom:10px">Update Task for <span style="color:rgb(248, 157, 10)"><?php echo $sname ?> </span></h2>
         <hr>
          </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12"> <form action="hrtaskupdate2.php" method="post">

                  <div class="single-query form-group" >
                <label>Title</label>
                    <input class="keyword-input" name="title" required="" type="text"  value="<?php echo $title ?>"/>
                  </div>
                </div>
      
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="single-query form-group" >     <label>Date Request</label>
                  <input required type="text" class="keyword-input" name="datereq"  onfocus="(this.type='date')"  value=<?php echo $datereq ?>>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="single-query form-group" >
                  <label>Deadline</label>
                  <input required type="text" class="keyword-input" name="deadline"  value=<?php echo $dateline ?>  onfocus="(this.type='date')"/>
                  </div>
                </div>
                <!--Link -------------------------------------------->
             <div class="col-md-12 col-sm-6 col-xs-12">
                  ...
                  <input type="url"  value=<?php echo $link ?> class="keyword-input" name="link"/>
                  </div>
                </div> 
                        <!--Link -------------------------------------------->
                <div class="col-md-12 top20">     <label>Details of Task</label>
          
                  <textarea name="description" id="description" rows="7"   class="form-control description"> <?php echo $detail ?>
             </textarea>
                </div>
